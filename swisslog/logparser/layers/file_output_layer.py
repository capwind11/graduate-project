    ...
    def outputResult(self):
        ...
        for key in self.templates.keys():
            ...
            for logid in self.templates[key]:
                self.log_messages[logid-1]['EventTemplate'] = key
                self.log_messages[logid-1]['EventId'] = eid
            log_events.append(dict(EventId=eid, EventTemplate=key, Occurrences=len(self.templates[key])))
